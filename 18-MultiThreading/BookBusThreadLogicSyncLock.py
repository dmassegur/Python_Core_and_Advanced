...
# We use lock, acquire and release to lock that object so no other thread calls it in the meantime
class BookMyBus() :
    
    def __init__(self,seats):
        self.availableSeats = seats
        self.lok = Lock()   ## Lock() is a class from the threading module 
